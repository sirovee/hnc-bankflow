...
export interface EnrichedTransaction extends RawTransaction { id:string;category:string|null;_val:ValidationResult|null;_match:MatchResult;_auto_corrected:boolean;_suggested:boolean;_suggestion:string|null;_isDuplicate:boolean;_isRedFlag:boolean;_isVerified:boolean;_parseWarn:boolean;_selected:boolean }
